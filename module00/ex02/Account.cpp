...
/*   Updated: 2023/07/10 16:13:13 by dlu              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Get the amount of the current account. */
...
void	Account::_displayTimestamp() {
	...
	std::cout
		<< "[" << std::setfill('0')
		<< std::setw(4) << current->tm_year + 1900
		<< std::setw(2) << current->tm_mon
		<< std::setw(2) << current->tm_mday
		<< "_" 
		<< std::setw(2) << current->tm_hour
		<< std::setw(2) << current->tm_min
